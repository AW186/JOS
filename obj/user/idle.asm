...
umain(int argc, char **argv)
{
  ...
  800036:	83 ec 08             	sub    $0x8,%esp
	binaryname = "idle";
  800039:	c7 05 00 20 80 00 80 	movl   $0x801080,0x802000
  800040:	10 80 00 
...
sys_env_destroy(envid_t envid)
{
  ...
  80010f:	68 8f 10 80 00       	push   $0x80108f
  800114:	6a 23                	push   $0x23
  800116:	68 ac 10 80 00       	push   $0x8010ac
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800190:	68 8f 10 80 00       	push   $0x80108f
  800195:	6a 23                	push   $0x23
  800197:	68 ac 10 80 00       	push   $0x8010ac
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  8001d2:	68 8f 10 80 00       	push   $0x80108f
  8001d7:	6a 23                	push   $0x23
  8001d9:	68 ac 10 80 00       	push   $0x8010ac
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800214:	68 8f 10 80 00       	push   $0x80108f
  800219:	6a 23                	push   $0x23
  80021b:	68 ac 10 80 00       	push   $0x8010ac
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800256:	68 8f 10 80 00       	push   $0x80108f
  80025b:	6a 23                	push   $0x23
  80025d:	68 ac 10 80 00       	push   $0x8010ac
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800298:	68 8f 10 80 00       	push   $0x80108f
  80029d:	6a 23                	push   $0x23
  80029f:	68 ac 10 80 00       	push   $0x8010ac
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  8002da:	68 8f 10 80 00       	push   $0x80108f
  8002df:	6a 23                	push   $0x23
  8002e1:	68 ac 10 80 00       	push   $0x8010ac
...
sys_ipc_recv(void *dstva)
{
  ...
  80033e:	68 8f 10 80 00       	push   $0x80108f
  800343:	6a 23                	push   $0x23
  800345:	68 ac 10 80 00       	push   $0x8010ac
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  80036b:	56                   	push   %esi
  80036c:	50                   	push   %eax
  80036d:	68 bc 10 80 00       	push   $0x8010bc
  ...
  80037e:	e8 56 00 00 00       	call   8003d9 <vcprintf>
	cprintf("\n");
  800383:	c7 04 24 df 10 80 00 	movl   $0x8010df,(%esp)
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8004d2:	0f be 80 e1 10 80 00 	movsbl 0x8010e1(%eax),%eax
  8004d9:	50                   	push   %eax
...
00800521 <vprintfmt>:
{
  ...
  800665:	52                   	push   %edx
  800666:	68 02 11 80 00       	push   $0x801102
  80066b:	53                   	push   %ebx
  80066c:	56                   	push   %esi
  ...
  80067d:	50                   	push   %eax
  80067e:	68 f9 10 80 00       	push   $0x8010f9
  800683:	53                   	push   %ebx
  800684:	56                   	push   %esi
  ...
  8006a5:	b8 f2 10 80 00       	mov    $0x8010f2,%eax
  ...
  800790:	b8 f2 10 80 00       	mov    $0x8010f2,%eax
