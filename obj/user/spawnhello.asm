...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  8000ef:	56                   	push   %esi
  8000f0:	50                   	push   %eax
  8000f1:	68 d8 24 80 00       	push   $0x8024d8
	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  800256:	0f be 80 fb 24 80 00 	movsbl 0x8024fb(%eax),%eax
  80025d:	50                   	push   %eax
...
008002a5 <vprintfmt>:
{
  ...
  800401:	50                   	push   %eax
  800402:	68 13 25 80 00       	push   $0x802513
  800407:	53                   	push   %ebx
  800408:	56                   	push   %esi
  ...
  800429:	b8 0c 25 80 00       	mov    $0x80250c,%eax
  ...
  800514:	b8 0c 25 80 00       	mov    $0x80250c,%eax
