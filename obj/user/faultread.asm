	 ...
	 unsigned long long num, unsigned base, int width, int padc)
{
  ...
  8001e3:	0f be 80 a8 10 80 00 	movsbl 0x8010a8(%eax),%eax
  8001ea:	50                   	push   %eax
...
00800232 <vprintfmt>:
{
  ...
  80029d:	ff 24 85 e0 11 80 00 	jmp    *0x8011e0(,%eax,4)
  ...
  80036b:	8b 14 85 40 13 80 00 	mov    0x801340(,%eax,4),%edx
  800372:	85 d2                	test   %edx,%edx
  800374:	74 18                	je     80038e <vprintfmt+0x15c>
				printfmt(putch, putdat, "%s", p);
  800376:	52                   	push   %edx
  800377:	68 c9 10 80 00       	push   $0x8010c9
  80037c:	53                   	push   %ebx
  80037d:	56                   	push   %esi
  ...
  80038e:	50                   	push   %eax
  80038f:	68 c0 10 80 00       	push   $0x8010c0
  800394:	53                   	push   %ebx
  800395:	56                   	push   %esi
  ...
  8003b6:	b8 b9 10 80 00       	mov    $0x8010b9,%eax
  ...
  8004a1:	b8 b9 10 80 00       	mov    $0x8010b9,%eax
...
sys_env_destroy(envid_t envid)
{
  ...
  800bad:	68 9f 13 80 00       	push   $0x80139f
  800bb2:	6a 23                	push   $0x23
  800bb4:	68 bc 13 80 00       	push   $0x8013bc
...
sys_page_alloc(envid_t envid, void *va, int perm)
{
  ...
  800c2e:	68 9f 13 80 00       	push   $0x80139f
  800c33:	6a 23                	push   $0x23
  800c35:	68 bc 13 80 00       	push   $0x8013bc
...
sys_page_map(envid_t srcenv, void *srcva, envid_t dstenv, void *dstva, int perm)
{
  ...
  800c70:	68 9f 13 80 00       	push   $0x80139f
  800c75:	6a 23                	push   $0x23
  800c77:	68 bc 13 80 00       	push   $0x8013bc
...
sys_page_unmap(envid_t envid, void *va)
{
  ...
  800cb2:	68 9f 13 80 00       	push   $0x80139f
  800cb7:	6a 23                	push   $0x23
  800cb9:	68 bc 13 80 00       	push   $0x8013bc
...
sys_env_set_status(envid_t envid, int status)
{
  ...
  800cf4:	68 9f 13 80 00       	push   $0x80139f
  800cf9:	6a 23                	push   $0x23
  800cfb:	68 bc 13 80 00       	push   $0x8013bc
...
sys_env_set_trapframe(envid_t envid, struct Trapframe *tf)
{
  ...
  800d36:	68 9f 13 80 00       	push   $0x80139f
  800d3b:	6a 23                	push   $0x23
  800d3d:	68 bc 13 80 00       	push   $0x8013bc
...
sys_env_set_pgfault_upcall(envid_t envid, void *upcall)
{
  ...
  800d78:	68 9f 13 80 00       	push   $0x80139f
  800d7d:	6a 23                	push   $0x23
  800d7f:	68 bc 13 80 00       	push   $0x8013bc
...
sys_ipc_recv(void *dstva)
{
  ...
  800ddc:	68 9f 13 80 00       	push   $0x80139f
  800de1:	6a 23                	push   $0x23
  800de3:	68 bc 13 80 00       	push   $0x8013bc
...
_panic(const char *file, int line, const char *fmt, ...)
{
  ...
  800e09:	56                   	push   %esi
  800e0a:	50                   	push   %eax
  800e0b:	68 cc 13 80 00       	push   $0x8013cc
  ...
  800e1c:	e8 c9 f2 ff ff       	call   8000ea <vcprintf>
	cprintf("\n");
  800e21:	c7 04 24 9c 10 80 00 	movl   $0x80109c,(%esp)
